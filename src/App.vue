...
export default {
  ...
  methods: {
    toggleFavoriteStatus(frienId) {
      const identifidedFriend = this.friends.find(
        (friend) => frienId === friend.id
      );
